...
public class TextBuddyHelper {
     ...
     * 
     * @param fileName
     *            The name of the file to be loaded/created.
     * @param toCleanLoad
     *            If set to true, then a new file will be created, and any files
     *            of the same name will be overridden. If set to false, then if
     *            there are files of the same name, that will be loaded instead.
     */
    ...
    /**
     * Checks if the file exists. If file does not exist, print file creation
     * message.
     */
    private void checkFileExists() {
        ...
        if (!file.exists()) {
            ...
            System.out.println(file.toString()
                               + " does not exist in root directory: "
                               + filePath + ". Creating the file now.");
     ...
     * 
     * @param toCleanLoad
     *            If set to true, function will create and overwrite any file
     *            with the same name, starting clean. If set to false, function
     *            will instead load the file, and not overwrite.
     */
    ...
    /**
     * Fills a given list with given file contents, and returns the list. If not
     * given a list, creates a new list on the spot.
     * 
     * @param list
     *            The List<String> object to be filled with file contents.
     * @param file
     *            The File object to be used to fill up list with its contents.
    ...
    private void inputHandler() {
        ...
        while (toContinue) {
            ...
            if (!trailingContent.isEmpty()) {
                ...
                trailingContent =
                        trailingContent.substring(1, trailingContent.length());
            }
     ...
     *            Any input entered after the command.
     ...
     * 
     * @param list
     *            The List object contains the data to be written.
     * @param file
     *            The File object for the data to be written to.
     */
    ...
    /**
     * Appends a given line of text to fileContents. Returns a String to be
     * printed as a confirmation message for the user.
     * 
     * @param toAdd
     *            String to be added into fileContents.
     ...
     * 
     * @return A String object that contains fileContents in a printable format.
     *         Also acts as a confirmation message.
     */
    ...
    private String executeDeleteCommand(String toDelete) {
        ...
        try {
            ...
            return "Please only input a natural number in the range: 1 to "
                   + fileContents.size() + ". \n";
            ...
            if (!fileContents.isEmpty()) {
                ...
                return "Unable to remove non-existent line. Please input a number from: 1 to "
                       + fileContents.size() + ". \n";
    ...
    /**
     * Function to be called when executing the Clear command. Returns a String
     * to be printed as a confirmation message for the user.
     * 
     * @return A String object that acts as a confirmation message.
     */
    ...
    /**
     * Function to be called when executing the Sort command. Returns a String
     * to be printed as a confirmation message for the user.
     * 
     * @return A String object that acts as a confirmation message.
     */
    ...
    /**
     * Code that actually handles the search function. Returns a String to be
     * printed as a 'results' message for the user.
     * 
     * @param searchTerm
     *            String object containing string to be searched within
     *            fileContents.
     * @return A String object that contains all relevant items with respect to
     *         the searchItem given.
     */
    ...
    /**
     * Given a list, returns a String containing the list contents, behavior
     * changes according to second argument.
     * 
     * @param list
     *            The List object to be printed.
     * @param useDefaultBehavior
     *            Determines function behavior. If this is true, it will return
     *            each entry along with their accompanying indexes as per
     *            normal. If this is false, it will return each entry along with
     *            their accompanying indexes in relation to their position in
     *            the second list.
     * @param secondList
     *            See defaultBehavior.
    ...
    private String printList(List<String> list, boolean useDefaultBehavior,
        ...
        if (!list.isEmpty()) {
            ...
            returnVal =
                    printListWriteString(list, useDefaultBehavior, secondList,
                                         returnVal);
    ...
    /**
     * The printList() code that actually appends list contents to the given
     * String.
     * 
     * @return A String containing only the list contents in a printable format,
     *         without a header.
     */
    private String printListWriteString(List<String> list,
                                        boolean useDefaultBehavior,
                                        List<String> secondList,
                                        String returnVal) {
        ...
        for (int index = 0; index < list.size(); index++) {
            ...
            if (useDefaultBehavior) {
                ...
                returnVal +=
                        (secondList.indexOf(list.get(index)) + 1) + ". "
                                + list.get(index) + "\n";
            }
        }
